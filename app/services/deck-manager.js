...
export default class DeckManagerService extends Service {
  ...
  getDeckFromCsv(csvData) {
    ...
    let deckData = {
      ...
      creatureCount: 1 * csvData['Creature Count'],
      actionCount: 1 * csvData['Action Count'],
      artifactCount: 1 * csvData['Artifact Count'],
      upgradeCount: 1 * csvData['Upgrade Count'],
      rawAmber: csvData['Bonus Amber'],
